...
[27 ]: 'End bracket for dynamic directive argument was not found. ' +
...
[39 ]: `Extraneous children found when component already has explicitly named ` +
...
result = props.properties.some(p => p.key.type === 4  &&
...
context.onError(createCompilerError(45 , node.loc, undefined, message));
}
}
...
(` ` ), undefined, undefined, true , !isStableFragment , false , node.loc);
return () => {
let childBlock;
